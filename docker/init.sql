...
ALTER TABLE ONLY "public"."game" ADD CONSTRAINT "FK_8c2a5454985e4dc7a87b55cacc7" FOREIGN KEY ("user2Id") REFERENCES "user"(id) NOT DEFERRABLE;
ALTER TABLE ONLY "public"."game" ADD CONSTRAINT "FK_cf8f3988639395bfeb47655b749" FOREIGN KEY ("user1Id") REFERENCES "user"(id) NOT DEFERRABLE;
